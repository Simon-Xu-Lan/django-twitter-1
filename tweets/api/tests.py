...
class TweetApiTests(TestCase):
    ...
    def test_create_api(self):
        ...
        # 必须带 content,  这里没有调用 testcase中的createtweet（）
    ...
    def test_retrieve(self):
        ...
        self.create_comment(self.user2, tweet, "check")
        self.create_comment(self.user1, tweet, "lskdjflsdkj")
